...
$(function() {
    ...
    $('#startTime_dryGoods').datepicker('setDate',new Date());
    ...
    $('#endTime_dryGoods').datepicker('setDate',new Date("2099-01-01"));
    ...
    //         autoclose: true
    //     });
    //     $(this).datepicker('setDate',new Date("2099-01-06"));
    //     // $(this).datetimepicker({
