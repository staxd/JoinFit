                        ...
                        $(".actionChoose_item").each(function(index, element) {
                            $(element).on("click", function(event) {
                                ...
                                $.each(action_video, function(k, v) {
                                    var video_html = "<a class='upImageBox_term clearVideoFile'><video src='" + v + "'></video><i class='del_icon '></i></a>";
                                ...
                                $('.chooseVideoBox').find('.del_icon').each(function(index, element) {
                                    $(this).on('click', function(event) {
                                        $.each(action_video, function(k, v) {
                                            if (v == $('.chooseVideoBox').find('.del_icon').eq(index).prev('video').attr("src")) {
                                                delete action_video[k];
                                            }
                                        });
                                        $('.chooseVideoBox').find('.del_icon').eq(index).parent('a').remove();
                                    });
                                });
