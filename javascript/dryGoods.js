...
function getDataRow(h) {
    ...
    if(state[parseInt(h.status)] == "暂存") {
        row.append("<td class='state-dryGoods state_disables'>" + state[parseInt(h.status)] + "</td>");
    } else {
        row.append("<td class='state-dryGoods state_enabel'>" + state[parseInt(h.status)] + "</td>");
    }
